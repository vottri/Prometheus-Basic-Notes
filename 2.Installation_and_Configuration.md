...
Do this on both Linux machines.
...
![ping1](https://raw.githubusercontent.com/vottri/Prometheus-Grafana-Basic-Notes/main/images/ping1.png)
![ping2](https://raw.githubusercontent.com/vottri/Prometheus-Grafana-Basic-Notes/main/images/ping2.png)
...
Or you can check the port 9100 of the Linux machine you installed node_exporter, it will list the system metrics in raw form. (e.g.)
...
Access Prometheus in a web browser at http://<Prometheus server public IP>:9090. Click "Status" >> "Runtime & Build Information". Verify that your Alertmanager instance appears under the "Alertmanagers" section.

![promui3](https://raw.githubusercontent.com/vottri/Prometheus-Grafana-Basic-Notes/main/images/promui3.png)
  
Visit port 9090 of prometheus server in a browser (e.g. http://mysite.com:9090). Click "Alert" button and it will show all the alerts configured in the "rules.yml" file.
...
Copy and note the newly created password (you will need it later).
...
First, running some programs in the background to put load on your machine's CPU or RAM, then navigate to your Grafana Dashboard. 
